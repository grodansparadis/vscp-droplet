...
#define PRJDEF_INIT_BUTTON_GPIO_PIN    0
#define PRJDEF_INIT_BUTTON_ACTIVE_LEVEL 0
...
#define PRJDEF_DROPLET_CHANNEL 1
...
*/
#define THIS_FIRMWARE_DEVICE_NAME "VSCP Alpha Node"
